package com.challengeforoalura.foroalura.infra.security;
...
public class TokenService {
    ...
    public String verificarToken(String token){
        ...
        if (token.isBlank() || token == null){
            throw new RuntimeException("No se ah enviado el token");
        }
        ...
        if (verifier.getSubject() == null){
            throw new RuntimeException("No se ah podido verificar el token");
        }
